...
def split_with_watershed(comp_mask: np.ndarray) -> list:
    """Split a merged blob into individual objects via distance transform + watershed.

    Returns a list of sub-masks. If only one peak is found the original mask
    ...
    # Sure-foreground: pixels whose distance-to-edge > 35 % of local max = tree centres
    ...
    # cv2.watershed needs a 3-channel BGR image
